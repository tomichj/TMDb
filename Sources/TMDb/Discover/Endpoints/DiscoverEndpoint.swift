...
enum DiscoverEndpoint {
    ...
    case tvSeries(sortedBy: TVSeriesSort? = nil, genres: [Genre.ID]? = nil, withOriginCountry: String? = nil, withAirDateGTE: Date? = nil, page: Int? = nil)
...
extension DiscoverEndpoint: Endpoint {
    ...
    var path: URL {
        ...
        case .tvSeries(let sortedBy, let genres, let originCountry, let airDateGTE, let page):
            return Self.basePath
